...
stone_values = list(map(int, input("Enter stone values separated by spaces: ").strip().split()))
result = longest_subsequence_divisible_by_5(stone_values)
print("Longest subsequence with sum divisible by 5:", result if result else "No subsequence found.")
